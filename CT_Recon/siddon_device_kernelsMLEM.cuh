...
{
	float3 detector;
	detector.x = pixel_iterate2(Det.NumAxPixels, Det.AxPixDimMm, CalParam.M, depth_iterate);
	detector.y = CalParam.R - CalParam.Rf;
	detector.z = pixel_iterate2(Det.NumTAxPixels, Det.TAxPixDimMm, CalParam.M, height_iterate);
